...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './transactions/pages/transaction-index/transaction-index.module'
      ).then((m) => m.TransactionIndexPageModule),
  },
  {
    path: 'settings',
    loadChildren: () =>
      import('./settings/pages/setting-index/setting-index.module').then(
        (m) => m.SettingIndexPageModule
      ),
  },
  {
    path: 'reports',
    loadChildren: () =>
      import('./reports/pages/report-index/report-index.module').then(
